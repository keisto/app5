<section class="section">
    <div class="container">
        <h1 class="box-title">
            <span class="icon is-medium"><i class="far fa-user-times fa-lg"></i></span>
            <span>Inactive Employees <span class="tag is-link has-text-weight-bold">{{ count($users) }}</span></span>
        </h1>
