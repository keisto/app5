    ...
    <div class="container">
        ...
        <div class="columns is-mobile">
            <div class="column is-one-quarter">
                ...
                {{ Form::text('start', $dispatch ? $start : '', ['placeholder' => 'Start Time', 'class' => 'input starttime', 'id' => 'start']) }}
            </div>
            <div class="column is-one-quarter">
                {{ Form::label('arrive', 'Arrive Time', ['class' => 'label']) }}
                {{ Form::text('arrive', '', ['placeholder' => 'Arrive Time', 'class' => 'input starttime', 'id' => 'arrive']) }}
            </div>
            <div class="column is-one-quarter">
                {{ Form::label('depart', 'Depart Time', ['class' => 'label']) }}
                {{ Form::text('depart', '', ['placeholder' => 'Depart Time', 'class' => 'input stoptime', 'id' => 'depart']) }}
            </div>
            <div class="column is-one-quarter">
